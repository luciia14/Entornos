...
SLEEP_INTERVAL = 1  # Tiempo entre actualizaciones en segundos
...
def buscar_precipitacion_por_hora(df, precipitaciones, hora_simulada):
    """Busca el valor de precipitaciones en el DataFrame dado una hora simulada."""
...
async def iniciar_servidor_pluviometro():
    """Inicia el servidor OPC UA para el pluviómetro y crea nodos."""
    servidor = Server()
...
async def conectar_servidor_temporal():
    """Establece la conexión al servidor temporal OPC UA y obtiene el nodo de la hora simulada."""
...
async def main():
    """Función principal que coordina el servidor OPC UA y el cliente temporal."""
    ...
    try:
        while True:
            ...
            # Buscar precipitaciones correspondientes
            ...
            if valor_precipitacion is not None:
                # Actualizar nodos en el servidor del pluviómetro
